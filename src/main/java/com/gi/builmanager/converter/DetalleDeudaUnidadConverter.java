...
public class DetalleDeudaUnidadConverter implements Converter<DetalleDeudaUnidadDto, DetalleDeudadUnidad> {

    private static DetalleDeudaUnidadConverter instance;

    private GastoComunConverter gastoComunConverter = GastoComunConverter.getInstance();

    private DetalleDeudaUnidadConverter() {}

    public static DetalleDeudaUnidadConverter getInstance() {
        return instance == null ? instance = new DetalleDeudaUnidadConverter() : instance;
    }
    ...
    public DetalleDeudadUnidad convert(DetalleDeudaUnidadDto dto) {
        ...
        detalle.setFactorProrrateo(dto.getFactorProrrateo());
