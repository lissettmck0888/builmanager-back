...
@Component
public class AssignmentPrimaryRepository extends AssignmentRepository {
    ...
    @Autowired
    private AssignmentSqlMapper assignmentSqlMapper;
    ...
    @Override
    public Integer saveAll(List<Assignment> aggregate) {
        return null;
    }
